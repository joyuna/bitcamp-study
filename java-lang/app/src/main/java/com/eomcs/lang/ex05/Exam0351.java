...
public class Exam0351 {
  public static void main(String[] args) {
    ...
    System.out.println(54 & 0b0000_0001); // 이 코드를 보고 홀수인지 짝수인지 알아볼수 있어야한다.
    ...
    // 예)
    //    0011 0110 (54) 끝이 0이면 짝수이고, 끝이 1이면 홀수다.***
    //  & 0000 0001 (뒤의 1비트의 값을 추출)
    // --------------
    //    0000 0000 추출된 값은 0이다. 즉 나머지가 없다. => 마스크 효과 :그냥 통과되는 듯한 ,, 값이 차단되는것처럼 앞에 있는 비트는 다 차단되고, 맨 끝자리만 바로 통과한다(맨뒤가 1이면 1, 맨뒤에가 0이면 0)
    //
    //    0011 0101 (53)
    //  & 0000 0001
    // --------------
